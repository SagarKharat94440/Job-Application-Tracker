...
public class EmailService {
	...
	public void sendResetEmail(String to, String token) {
		try {
			...
			helper.setTo(to);
			helper.setSubject("Reset Password - Job Application- Tracker");
			...
			String htmlContent = """
					<div style="background-color: #f3f4f6; padding: 20px; font-family: sans-serif;">
					    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
					        ...
					        <p style="color: #4b5563; line-height: 1.6;">You requested to reset your password for Job Application- Tracker. Please click the button below to proceed:</p>
	...
	public void sendForwardingHelper(String to, String code, String link) {
		try {
			...
			html.append("<p>Google requires verification to start forwarding emails to Job Application- Tracker.</p>");
    ...
    public void sendVerificationEmail(String to, String token) {
        try {
            ...
            helper.setFrom(fromEmail, fromName);
            helper.setTo(to);
            helper.setSubject("Verify Your Account - JobApplicationTracker");
            ...
            String htmlContent = """
                <div style="background-color: #0B0E14; padding: 40px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #D1D5DB;">
                    <div style="max-width: 600px; margin: 0 auto; background-color: #151A23; padding: 40px; border-radius: 16px; border: 1px solid #1F2937;">
						<h1 style="color: #FFFFFF; font-size: 24px; font-weight: 800; margin-bottom: 16px;">Welcome to Job Application- Tracker!</h1>
